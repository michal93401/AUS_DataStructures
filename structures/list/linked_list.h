...
namespace structures
{
    ...
    protected:
        ...
        void rePtr(LinkedListItem<T>* ptr1, LinkedListItem<T>* ptr2);
        LinkedListItem<T>* newItem(const T& data);
    ...
    inline void LinkedList<T>::add(const T& data)
    {
        ...
        template<typename T>
        inline void LinkedList<T>::rePtr(LinkedListItem<T>* ptr1, LinkedListItem<T>* ptr2)
        {
            ptr1->setNext(ptr2);
        }

        template<typename T>
        inline LinkedListItem<T>* LinkedList<T>::newItem(const T& data)
        {
            return new LinkedListItem<T>(data);
        }
